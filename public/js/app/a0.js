...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    /* src */
    setCurrentNoteStore() {
      $fetot_store_worker__WEBPACK_IMPORTED_MODULE_3__["default"].getStore('current-note').actions.update(this.block);
    }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    currentBlocks() {
      ...
      return Object.entries(blocks).map(([id, block]) => block); // return this.currentBlocksStore.getters.getLikeArray();
    },
        ...
        fn: function() {
          return _vm._l(_vm.currentBlocks, function(block, index) {
            return _c("notes-block", {
              ...
              attrs: { block: block },
              on: {
                "edit-note-event": _vm.openFrameHandler,
                "delete-note-event": _vm.deleteNoteEventHandler
              }
            })
          })
